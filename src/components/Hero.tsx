      ...
      <div className="relative z-10 mx-auto grid w-full max-w-[1440px] items-center gap-7 px-5 pb-24 pt-24 md:min-h-[100svh] md:grid-cols-[minmax(0,0.95fr)_minmax(320px,1.05fr)] md:px-8 md:pb-24 md:pt-28 lg:gap-12 lg:px-14 xl:px-20">
        <div className="relative z-10 mx-auto w-full max-w-2xl md:mx-0">
          <motion.div {...reveal(0.12)} className="flex flex-col items-start">
            <div className="hero-logo-shell grid h-36 w-36 shrink-0 place-items-center rounded-full sm:h-36 sm:w-36 lg:h-[168px] lg:w-[168px]">
              <img
                src={ammaLogo}
          ...
          <motion.p
            {...reveal(0.24)}
            className="hero-label mt-5 inline-flex items-center rounded-full px-4 py-2 text-[0.58rem] font-medium tracking-[0.18em] text-primary sm:text-[0.65rem]"
          >
          ...
          <motion.h1
            {...reveal(0.36)}
            className="mt-5 font-display text-[2.75rem] leading-[0.98] text-primary sm:text-[3.55rem] md:text-[3.2rem] lg:text-[4rem] xl:text-[4.65rem]"
          >
            Natural Goodness,
            <br />
          ...
          <motion.p
            {...reveal(0.48)}
            className="mt-5 max-w-xl text-sm leading-7 text-foreground/72 sm:text-[0.95rem]"
          >
        ...
        >
          <motion.div
            ...
            className="hero-image-frame absolute inset-3 overflow-hidden md:inset-0"
          >
            <img
              src={heroImage}
